...
//	}
	...
	static	void						Reset( int threadIndex );
	static	void						Increment_Frame_Counter( void );
	static	int							Get_Frame_Count_Since_Reset( int threadIndex );
	static	float						Get_Time_Since_Reset( int threadIndex );
	static	float						Get_Time_Since_Reset_Min( int threadIndex );
	static	float						Get_Time_Since_Reset_Max( int threadIndex );
